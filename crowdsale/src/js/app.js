App = {
  ...
  initContract: function() {
    $.getJSON('GoodCitizenNetworkCrowdsale.json', function(data) {
      // Get the necessary contract artifact file and instantiate it with truffle-contract.
      var GoodCitizenNetworkCrowdsaleArtifact = data;
      App.contracts.GoodCitizenNetworkCrowdsale = TruffleContract(GoodCitizenNetworkCrowdsaleArtifact);

      // Set the provider for our contract.
      App.contracts.GoodCitizenNetworkCrowdsale.setProvider(App.web3Provider);
  ...
  handleBuy1Tokens: function send() {
    App.contracts.GoodCitizenNetworkCrowdsale.deployed().then(function(instance) {
      crowdsale = instance;
  ...
  getTokenContractAddress: function(){
    ...
    App.contracts.GoodCitizenNetworkCrowdsale.deployed().then(function(instance) {
      ...
      console.log('GoodCitizenNetworkCrowdsale Address: ' + crowdsaleAddress);
      return crowdsale.token()
  ...
  getEthRefundValue: function() {
    ...
    App.contracts.GoodCitizenNetworkCrowdsale.deployed()
